...
class ParsingService:
    ...
    async def parse_and_persist(
        ...
        *,
        ...
        # Resolve before hashing so the persisted config records what actually
        # ran, and so config_hash describes the config that is stored with it.
        config = normalize_parse_config(config)
